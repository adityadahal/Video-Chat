...
export class Base extends Settings {
  ...
  toggleCamera(cameraPrivacy?: boolean): void {
    ...
    cameraPrivacy =
      cameraPrivacy === undefined ? !this.cameraPrivacy : cameraPrivacy;
  ...
  toggleMic(microphonePrivacy?: boolean): void {
    microphonePrivacy =
      microphonePrivacy === undefined
        ? !this.microphonePrivacy
        : microphonePrivacy;
  ...
  toggleSpeaker(speakerPrivacy?: any): void {
    speakerPrivacy =
      speakerPrivacy === undefined ? !this.speakerPrivacy : speakerPrivacy;
